...
export default function Monuments() {
  ...
  function ready() {
    ...
    .then((res) => {
      ...
      if (len !== 0) {
        monumentsSheet.insertAdjacentHTML('afterbegin','<th>name</th><th>description</th><th>address</th><th>date</th><th>monumentView</th><th>_id</th><th><input id="select-all" type="checkbox"/></th>')
        for (let i = 0; i < len; i++){
